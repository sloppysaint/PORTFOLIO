      ...
      <div className="container mx-auto h-full">
        <div className="flex flex-col items-center justify-between xl:flex-row xl:pt-8 xl:pb-24">
          <div className="text-center xl:text-left order-2 xl:order-none ">
            <span className="text-xl sm:text-lg">Aspiring Software Developer</span>
            ...
            <div className="flex flex-col xl:flex-row items-center gap-8">
              <a
                href="/Piyush's_Resume.pdf"
                download="Piyush_Khattar_CV.pdf"
              >
                <Button
                  variant="outline"
                  size="lg"
                  className="uppercase flex items-center gap-2 hover:bg-accent hover:text-primary transition-all duration-500"
                >
